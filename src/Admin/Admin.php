<?php
namespace Carawebs\LandingPage\Admin;
...
class Admin {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $LandingPage       The name of this plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->LandingPage, plugin_dir_url( __FILE__ ) . 'css/LandingPage-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->LandingPage, plugin_dir_url( __FILE__ ) . 'js/LandingPage-admin.js', array( 'jquery' ), $this->version, false );
